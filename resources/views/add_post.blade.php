...
<div class="container my-3 py-5">
   <div class="card w-50 h-auto mx-auto shadow package-lead p-4">
        ...
        <div class="mb-3">
                ...
                <input type="text" class="form-control fs-5" id="postName" placeholder="Enter your post title" name="title">
                @error('title')
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control fs-5" id="postContent" rows="5" placeholder="Enter your content" name="content"></textarea>
                @error('content')
                    <span class="text-danger fw-semibold">Error message goes here</span>
                @enderror
            </div>
